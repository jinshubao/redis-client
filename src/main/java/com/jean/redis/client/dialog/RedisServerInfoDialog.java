 ...
 * 服务器信息对话框
 */
public class RedisServerInfoDialog extends Dialog<RedisServerProperty> {
    ...
    public RedisServerInfoDialog(@NamedArg("defaultValue") RedisServerProperty defaultValue) {
